  ...
  return (
    <nav className="container mx-auto px-4 py-6 flex items-center justify-between sticky top-0 bg-white/90 backdrop-blur-xl z-50 border-b border-gray-100">
      <div className="flex items-center">
        <span className="text-2xl font-bold ml-2 text-[#1a2352] font-display bg-gradient-to-r from-[#1a2352] to-[#ff7757] bg-clip-text text-transparent">NeumoAI</span>
      </div>
      <div className="hidden md:flex items-center space-x-8">
        ...
        <Button className="bg-gradient-to-r from-[#ff7757] to-[#ff5757] hover:opacity-90 shadow-lg hover:shadow-xl transition-all text-white">
          Sign Up
        </Button>
      </div>
      <MobileMenu />
