...
export function Navigation() {
  return (
    <nav className="container mx-auto px-4 py-6 flex items-center justify-between sticky top-0 bg-white/50 backdrop-blur-sm z-50 border-b border-gray-100/50">
