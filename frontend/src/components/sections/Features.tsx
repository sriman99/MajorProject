    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">Everything you need for comprehensive respiratory analysis</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-card rounded-xl p-8 hover:shadow-lg transition-shadow border border-border"
            >
